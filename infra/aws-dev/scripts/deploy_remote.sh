...

{
  ...
  write_env KAFKA_BOOTSTRAP_SERVERS "${KAFKA_BOOTSTRAP_SERVERS:-kafka:9092}"
  write_env BRAINX_KAFKA_MONITORING_CONSUMER_GROUP_ID "${BRAINX_KAFKA_MONITORING_CONSUMER_GROUP_ID:-intelligence-service}"
